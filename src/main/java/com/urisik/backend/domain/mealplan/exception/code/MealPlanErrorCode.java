...
public enum MealPlanErrorCode implements BaseErrorCode {
    ...
    DATE_RANGE_TOO_WIDE(HttpStatus.BAD_REQUEST,
            "MEAL_PLAN_400",
            "식단 조회 기간을 초과했습니다."),
    ...
    MEAL_PLAN_TODAY_EMPTY(HttpStatus.NOT_FOUND,
            "MEAL_PLAN_404",
            "오늘의 식단이 비어 있습니다."),

    MEAL_PLAN_WEEKLY_EMPTY(HttpStatus.NOT_FOUND,
            "MEAL_PLAN_404",
            "이번주 식단이 비어 있습니다."),
    ...
    MEAL_PLAN_NOT_CONFIRMED(HttpStatus.CONFLICT,
            "MEAL_PLAN_409",
            "확정되지 않은 식단입니다."),
